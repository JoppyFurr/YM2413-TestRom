...
static const gui_element_t melody_gui [ELEMENT_COUNT] = {
    [ELEMENT_MELODY_TAB] = {
        .type = TYPE_TAB, .max = 1, .x = 23, .y = 0,
        .cursor_x = 179, .cursor_y = 0, .cursor_w = 33, .cursor_h = 17,
        .up   = ELEMENT_MELODY_TAB,         .down  = ELEMENT_TOTAL_LEVEL,
        .left = ELEMENT_FEEDBACK,           .right = ELEMENT_RHYTHM_TAB
    },
    [ELEMENT_RHYTHM_TAB] = {
        .type = TYPE_TAB, .max = 1, .x = 27, .y = 0,
        .cursor_x = 213, .cursor_y = 0, .cursor_w = 38, .cursor_h = 17,
        .up   = ELEMENT_RHYTHM_TAB,         .down  = ELEMENT_TOTAL_LEVEL,
        .left = ELEMENT_MELODY_TAB,         .right = ELEMENT_RHYTHM_TAB
    },
    [ELEMENT_INSTRUMENT] = {
        .type = TYPE_VALUE, .max = 15, .x = 4, .y = 2,
        .cursor_x = 31, .cursor_y = 15, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_TOTAL_LEVEL] = {
        .type = TYPE_VALUE, .max = 63, .x = 25, .y = 3,
        .cursor_x = 199, .cursor_y = 23, .cursor_w = 39, .cursor_h = 18,
    ...
    [ELEMENT_MOD_MULTI] = {
        ...
        .cursor_x = 30, .cursor_y = 47, .cursor_w = 20, .cursor_h = 25,
    ...
    [ELEMENT_MOD_KSR] = {
        ...
        .cursor_x = 55, .cursor_y = 47, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_MOD_VIBRATO] = {
        ...
        .cursor_x = 79, .cursor_y = 47, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_MOD_WAVEFORM] = {
        ...
        .cursor_x = 102, .cursor_y = 47, .cursor_w = 20, .cursor_h = 22,
    ...
    [ELEMENT_MOD_ENVELOPE_TYPE] = {
        ...
        .cursor_x = 51, .cursor_y = 63, .cursor_w = 26, .cursor_h = 16,
    ...
    [ELEMENT_MOD_AM] = {
        ...
        .cursor_x = 79, .cursor_y = 63, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_MOD_KSL] = {
        ...
        .cursor_x = 127, .cursor_y = 47, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_MOD_ATTACK_RATE] = {
        ...
        .cursor_x = 148, .cursor_y = 47, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_MOD_DECAY_RATE] = {
        ...
        .cursor_x = 172, .cursor_y = 47, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_MOD_SUSTAIN_LEVEL] = {
        ...
        .cursor_x = 198, .cursor_y = 47, .cursor_w = 20, .cursor_h = 25,
    ...
    [ELEMENT_MOD_RELEASE_RATE] = {
        ...
        .cursor_x = 220, .cursor_y = 47, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_CAR_MULTI] = {
        ...
        .cursor_x = 30, .cursor_y = 87, .cursor_w = 20, .cursor_h = 25,
    ...
    [ELEMENT_CAR_KSR] = {
        ...
        .cursor_x = 55, .cursor_y = 87, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_CAR_VIBRATO] = {
        ...
        .cursor_x = 79, .cursor_y = 87, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_CAR_WAVEFORM] = {
        ...
        .cursor_x = 102, .cursor_y = 87, .cursor_w = 20, .cursor_h = 22,
    ...
    [ELEMENT_CAR_ENVELOPE_TYPE] = {
        ...
        .cursor_x = 51, .cursor_y = 103, .cursor_w = 26, .cursor_h = 16,
    ...
    [ELEMENT_CAR_AM] = {
        ...
        .cursor_x = 79, .cursor_y = 103, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_CAR_KSL] = {
        ...
        .cursor_x = 127, .cursor_y = 87, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_CAR_ATTACK_RATE] = {
        ...
        .cursor_x = 148, .cursor_y = 87, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_CAR_DECAY_RATE] = {
        ...
        .cursor_x = 172, .cursor_y = 87, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_CAR_SUSTAIN_LEVEL] = {
        ...
        .cursor_x = 198, .cursor_y = 87, .cursor_w = 20, .cursor_h = 25,
    ...
    [ELEMENT_CAR_RELEASE_RATE] = {
        ...
        .cursor_x = 220, .cursor_y = 87, .cursor_w = 24, .cursor_h = 25,
...
static const gui_element_t rhythm_gui [ELEMENT_COUNT] = {
    ...
    [ELEMENT_CH6_BLOCK] = {
        .type = TYPE_VALUE, .max = 7, .x = 7, .y = 4,
        .cursor_x = 53, .cursor_y = 31, .cursor_w = 22, .cursor_h = 25,
    ...
    [ELEMENT_CH6_FNUM] = {
        .type = TYPE_VALUE_WIDE, .max = 511, .x = 10, .y = 4,
        .cursor_x = 79, .cursor_y = 31, .cursor_w = 26, .cursor_h = 25,
    ...
    [ELEMENT_CH7_SUSTAIN] = {
        .type = TYPE_LED, .max = 1, .x = 4, .y = 11,
        .cursor_x = 31, .cursor_y = 87, .cursor_w = 18, .cursor_h = 17,
    ...
    [ELEMENT_CH7_BLOCK] = {
        .type = TYPE_VALUE, .max = 7, .x = 7, .y = 10,
        .cursor_x = 53, .cursor_y = 79, .cursor_w = 22, .cursor_h = 25,
    ...
    [ELEMENT_CH7_FNUM] = {
        .type = TYPE_VALUE_WIDE, .max = 511, .x = 10, .y = 10,
        .cursor_x = 79, .cursor_y = 79, .cursor_w = 26, .cursor_h = 25,
        .callback = register_write_ch7_fnum,
        .up   = ELEMENT_CH6_FNUM,           .down  = ELEMENT_CH8_FNUM,
        .left = ELEMENT_CH7_BLOCK,          .right = ELEMENT_SD_VOLUME
    },
    [ELEMENT_CH8_SUSTAIN] = {
        .type = TYPE_LED, .max = 1, .x = 4, .y = 19,
        .cursor_x = 31, .cursor_y = 151, .cursor_w = 18, .cursor_h = 17,
    ...
    [ELEMENT_CH8_BLOCK] = {
        .type = TYPE_VALUE, .max = 7, .x = 7, .y = 18,
        .cursor_x = 53, .cursor_y = 143, .cursor_w = 22, .cursor_h = 25,
    ...
    [ELEMENT_CH8_FNUM] = {
        .type = TYPE_VALUE_WIDE, .max = 511, .x = 10, .y = 18,
        .cursor_x = 79, .cursor_y = 143, .cursor_w = 26, .cursor_h = 25,
        .callback = register_write_ch8_fnum,
        .up   = ELEMENT_CH7_FNUM,           .down  = ELEMENT_CH8_FNUM,
        .left = ELEMENT_CH8_BLOCK,          .right = ELEMENT_TC_VOLUME
    },
    [ELEMENT_BD_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 16, .y = 4,
        .cursor_x = 127, .cursor_y = 31, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_BD_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 20, .y = 4,
        .cursor_x = 159, .cursor_y = 31, .cursor_w = 18, .cursor_h = 18,
        .callback = register_write_bd_key,
        .up   = ELEMENT_MELODY_TAB,         .down  = ELEMENT_HH_BUTTON,
        .left = ELEMENT_BD_VOLUME,          .right = ELEMENT_BD_BUTTON
    },
    [ELEMENT_HH_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 16, .y = 8,
        .cursor_x = 127, .cursor_y = 63, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_HH_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 20, .y = 8,
        .cursor_x = 159, .cursor_y = 63, .cursor_w = 18, .cursor_h = 18,
        .callback = register_write_hh_key,
        .up   = ELEMENT_BD_BUTTON,          .down  = ELEMENT_SD_BUTTON,
        .left = ELEMENT_HH_VOLUME,          .right = ELEMENT_HH_BUTTON
    },
    [ELEMENT_SD_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 16, .y = 12,
        .cursor_x = 127, .cursor_y = 95, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_SD_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 20, .y = 12,
        .cursor_x = 159, .cursor_y = 95, .cursor_w = 18, .cursor_h = 18,
        .callback = register_write_sd_key,
        .up   = ELEMENT_HH_BUTTON,          .down  = ELEMENT_TT_BUTTON,
        .left = ELEMENT_SD_VOLUME,          .right = ELEMENT_SD_BUTTON
    },
    [ELEMENT_TT_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 16, .y = 16,
        .cursor_x = 127, .cursor_y = 127, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_TT_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 20, .y = 16,
        .cursor_x = 159, .cursor_y = 127, .cursor_w = 18, .cursor_h = 18,
        .callback = register_write_tt_key,
        .up   = ELEMENT_SD_BUTTON,          .down  = ELEMENT_TC_BUTTON,
        .left = ELEMENT_TT_VOLUME,          .right = ELEMENT_TT_BUTTON
    },
    [ELEMENT_TC_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 16, .y = 20,
        .cursor_x = 127, .cursor_y = 159, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_TC_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 20, .y = 20,
        .cursor_x = 159, .cursor_y = 159, .cursor_w = 18, .cursor_h = 18,
