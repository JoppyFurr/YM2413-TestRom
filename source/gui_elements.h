...
static const gui_element_t melody_gui [ELEMENT_COUNT] = {
    ...
    [ELEMENT_INSTRUMENT] = {
        ...
        .cursor_x = 27, .cursor_y = 15, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_VOLUME] = {
        ...
        .cursor_x = 51, .cursor_y = 15, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_SUSTAIN] = {
        ...
        .cursor_x = 75, .cursor_y = 23, .cursor_w = 18, .cursor_h = 17,
    ...
    [ELEMENT_FEEDBACK] = {
        ...
        .cursor_x = 147, .cursor_y = 23, .cursor_w = 35, .cursor_h = 18,
    ...
    [ELEMENT_TOTAL_LEVEL] = {
        ...
        .cursor_x = 195, .cursor_y = 23, .cursor_w = 39, .cursor_h = 18,
    ...
    [ELEMENT_MOD_MULTI] = {
        ...
        .cursor_x = 26, .cursor_y = 47, .cursor_w = 20, .cursor_h = 25,
    ...
    [ELEMENT_MOD_KSR] = {
        ...
        .cursor_x = 51, .cursor_y = 47, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_MOD_VIBRATO] = {
        ...
        .cursor_x = 75, .cursor_y = 47, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_MOD_WAVEFORM] = {
        ...
        .cursor_x = 98, .cursor_y = 47, .cursor_w = 20, .cursor_h = 22,
    ...
    [ELEMENT_MOD_ENVELOPE_TYPE] = {
        ...
        .cursor_x = 47, .cursor_y = 63, .cursor_w = 26, .cursor_h = 16,
    ...
    [ELEMENT_MOD_AM] = {
        ...
        .cursor_x = 75, .cursor_y = 63, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_MOD_KSL] = {
        ...
        .cursor_x = 123, .cursor_y = 47, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_MOD_ATTACK_RATE] = {
        ...
        .cursor_x = 144, .cursor_y = 47, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_MOD_DECAY_RATE] = {
        ...
        .cursor_x = 168, .cursor_y = 47, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_MOD_SUSTAIN_LEVEL] = {
        ...
        .cursor_x =194, .cursor_y = 47, .cursor_w = 20, .cursor_h = 25,
    ...
    [ELEMENT_MOD_RELEASE_RATE] = {
        ...
        .cursor_x = 216, .cursor_y = 47, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_CAR_MULTI] = {
        ...
        .cursor_x = 26, .cursor_y = 87, .cursor_w = 20, .cursor_h = 25,
    ...
    [ELEMENT_CAR_KSR] = {
        ...
        .cursor_x = 51, .cursor_y = 87, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_CAR_VIBRATO] = {
        ...
        .cursor_x = 75, .cursor_y = 87, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_CAR_WAVEFORM] = {
        ...
        .cursor_x = 98, .cursor_y = 87, .cursor_w = 20, .cursor_h = 22,
    ...
    [ELEMENT_CAR_ENVELOPE_TYPE] = {
        ...
        .cursor_x = 47, .cursor_y = 103, .cursor_w = 26, .cursor_h = 16,
    ...
    [ELEMENT_CAR_AM] = {
        ...
        .cursor_x = 75, .cursor_y = 103, .cursor_w = 18, .cursor_h = 16,
    ...
    [ELEMENT_CAR_KSL] = {
        ...
        .cursor_x = 123, .cursor_y = 87, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_CAR_ATTACK_RATE] = {
        ...
        .cursor_x = 144, .cursor_y = 87, .cursor_w = 23, .cursor_h = 25,
    ...
    [ELEMENT_CAR_DECAY_RATE] = {
        ...
        .cursor_x = 168, .cursor_y = 87, .cursor_w = 24, .cursor_h = 25,
    ...
    [ELEMENT_CAR_SUSTAIN_LEVEL] = {
        ...
        .cursor_x = 194, .cursor_y = 87, .cursor_w = 20, .cursor_h = 25,
    ...
    [ELEMENT_CAR_RELEASE_RATE] = {
        ...
        .cursor_x = 216, .cursor_y = 87, .cursor_w = 24, .cursor_h = 25,
...
static const gui_element_t rhythm_gui [ELEMENT_COUNT] = {
    ...
    [ELEMENT_CH6_SUSTAIN] = {
        .type = TYPE_LED, .max = 1, .x = 5, .y = 5,
        .cursor_x = 35, .cursor_y = 39, .cursor_w = 18, .cursor_h = 17,
    ...
    [ELEMENT_CH6_BLOCK] = {
        .type = TYPE_VALUE, .max = 7, .x = 8, .y = 4,
        .cursor_x = 57, .cursor_y = 31, .cursor_w = 22, .cursor_h = 25,
    ...
    [ELEMENT_CH6_FNUM] = {
        .type = TYPE_VALUE_WIDE, .max = 511, .x = 11, .y = 4,
        .cursor_x = 83, .cursor_y = 31, .cursor_w = 26, .cursor_h = 25,
    ...
    [ELEMENT_CH7_SUSTAIN] = {
        .type = TYPE_LED, .max = 1, .x = 5, .y = 11,
        .cursor_x = 35, .cursor_y = 87, .cursor_w = 18, .cursor_h = 17,
    ...
    [ELEMENT_CH7_BLOCK] = {
        .type = TYPE_VALUE, .max = 7, .x = 8, .y = 10,
        .cursor_x = 57, .cursor_y = 79, .cursor_w = 22, .cursor_h = 25,
    ...
    [ELEMENT_CH7_FNUM] = {
        .type = TYPE_VALUE_WIDE, .max = 511, .x = 11, .y = 10,
        .cursor_x = 83, .cursor_y = 79, .cursor_w = 26, .cursor_h = 25,
        .callback = register_write_ch7_fnum,
        .up   = ELEMENT_CH6_FNUM,           .down  = ELEMENT_CH8_FNUM,
        .left = ELEMENT_CH7_BLOCK,          .right = ELEMENT_SD_VOLUME
    },
    [ELEMENT_CH8_SUSTAIN] = {
        .type = TYPE_LED, .max = 1, .x = 5, .y = 19,
        .cursor_x = 35, .cursor_y = 151, .cursor_w = 18, .cursor_h = 17,
    ...
    [ELEMENT_CH8_BLOCK] = {
        .type = TYPE_VALUE, .max = 7, .x = 8, .y = 18,
        .cursor_x = 57, .cursor_y = 143, .cursor_w = 22, .cursor_h = 25,
    ...
    [ELEMENT_CH8_FNUM] = {
        .type = TYPE_VALUE_WIDE, .max = 511, .x = 11, .y = 18,
        .cursor_x = 83, .cursor_y = 143, .cursor_w = 26, .cursor_h = 25,
        .callback = register_write_ch8_fnum,
        .up   = ELEMENT_CH7_FNUM,           .down  = ELEMENT_CH8_FNUM,
        .left = ELEMENT_CH8_BLOCK,          .right = ELEMENT_TC_VOLUME
    },
    [ELEMENT_BD_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 17, .y = 4,
        .cursor_x = 131, .cursor_y = 31, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_BD_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 21, .y = 4,
        .cursor_x = 163, .cursor_y = 31, .cursor_w = 18, .cursor_h = 18,
        .callback = register_write_bd_key,
        .up   = ELEMENT_MELODY_TAB,         .down  = ELEMENT_HH_BUTTON,
        .left = ELEMENT_BD_VOLUME,          .right = ELEMENT_BD_BUTTON
    },
    [ELEMENT_HH_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 17, .y = 8,
        .cursor_x = 131, .cursor_y = 63, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_HH_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 21, .y = 8,
        .cursor_x = 163, .cursor_y = 63, .cursor_w = 18, .cursor_h = 18,
        .callback = register_write_hh_key,
        .up   = ELEMENT_BD_BUTTON,          .down  = ELEMENT_SD_BUTTON,
        .left = ELEMENT_HH_VOLUME,          .right = ELEMENT_HH_BUTTON
    },
    [ELEMENT_SD_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 17, .y = 12,
        .cursor_x = 131, .cursor_y = 95, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_SD_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 21, .y = 12,
        .cursor_x = 163, .cursor_y = 95, .cursor_w = 18, .cursor_h = 18,
        .callback = register_write_sd_key,
        .up   = ELEMENT_HH_BUTTON,          .down  = ELEMENT_TT_BUTTON,
        .left = ELEMENT_SD_VOLUME,          .right = ELEMENT_SD_BUTTON
    },
    [ELEMENT_TT_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 17, .y = 16,
        .cursor_x = 131, .cursor_y = 127, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_TT_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 21, .y = 16,
        .cursor_x = 163, .cursor_y = 127, .cursor_w = 18, .cursor_h = 18,
        .callback = register_write_tt_key,
        .up   = ELEMENT_SD_BUTTON,          .down  = ELEMENT_TC_BUTTON,
        .left = ELEMENT_TT_VOLUME,          .right = ELEMENT_TT_BUTTON
    },
    [ELEMENT_TC_VOLUME] = {
        .type = TYPE_VALUE, .max = 15, .x = 17, .y = 20,
        .cursor_x = 131, .cursor_y = 159, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_TC_BUTTON] = {
        .type = TYPE_BUTTON, .max = 1, .x = 21, .y = 20,
        .cursor_x = 163, .cursor_y = 159, .cursor_w = 18, .cursor_h = 18,
